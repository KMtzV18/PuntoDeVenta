...
//        }
    ...
    private void initComponents() {
        ...
        btnAgregar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/DAOs/guardar.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/DAOs/cancelar2.png"))); // NOI18N
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        // TODO add your handling code here:
        DaoAgregar_Modificar dam = new DaoAgregar_Modificar();
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Posiblemente el codigo ya esta en uso");
            Timer timer = new Timer(2000, new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent evt) {
                        lblSioNo.setText("No Se Agrego el Producto");
                    }
                });
                timer.setRepeats(false); // Ejecutar solo una vez
                timer.start();
